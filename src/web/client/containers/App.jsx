      ...
      <header className='Header font-sans inline-block align-middle text-5xl pl-4 text-white'>
        <h2>
          ...
          <svg className='inline mb-2' width='.85em' height='.85em' viewBox='0 0 255 327' fill='none' xmlns='http://www.w3.org/2000/svg'>
            ...
            <path fillRule='evenodd' clipRule='evenodd' d='M162 76.7226V140H92V77.0074C103.269 73.7472 115.18 72 127.5 72C139.456 72 151.027 73.6456 162 76.7226Z' fill='#CC8A4D' />
            <circle cx='127' cy='199' r='109' fill='#3B76B7' />
            <path d='M159.778 233.315C126.778 245.815 155.278 292.815 153.278 304.315C151.278 315.815 126.778 310.815 126.778 310.815C126.778 310.815 113.778 227.315 126.778 200.815C139.778 174.315 196.668 159.315 202.278 165.315C207.887 171.315 192.778 220.815 159.778 233.315Z' fill='#324A78' />
            <path d='M94 233.5C127 246 98.5 293 100.5 304.5C102.5 316 127 311 127 311C127 311 140 227.5 127 201C114 174.5 57.1093 159.5 51.5 165.5C45.8907 171.5 61 221 94 233.5Z' fill='#324A78' />
